    ...
    <>
      <section className="container-wide pt-20 pb-10">
        <motion.div {...fade} className="max-w-3xl">
          <span className="section-eyebrow">Research · Publications</span>
          <h1 className="h2 mt-4 text-4xl sm:text-5xl">Peer-reviewed work from the BESSER team.</h1>
          <p className="lede">Selected papers at the intersection of low-code, modeling, and AI.</p>
